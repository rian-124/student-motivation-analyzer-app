    ...
    <Card className="border border-slate-200 dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900 rounded-2xl overflow-hidden h-fit">
      <CardContent className="p-0">
        ...
        <div className="h-24 bg-slate-50 dark:bg-slate-800/50 relative">
          <div className="absolute -bottom-10 left-1/2 -translate-x-1/2">
            <div className="relative group">
              <div className="w-20 h-20 rounded-2xl bg-white dark:bg-slate-900 border-4 border-white dark:border-slate-900 flex items-center justify-center text-2xl font-bold text-brand shadow-sm ring-1 ring-slate-100 dark:ring-slate-800">
                A
              </div>
        ...
        <div className="pt-12 p-6 text-center space-y-1">
          <h2 className="font-bold text-lg text-slate-800 dark:text-white">Admin Sistem</h2>
        ...
        <div className="px-6 pb-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-bold text-slate-700 dark:text-slate-300">Hari ini, 09:12</span>
            </div>
          </div>
        </div>
      </CardContent>
