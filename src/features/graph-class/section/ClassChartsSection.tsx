"use client"
 ...
 import { BarChart3, PieChart, Target, User } from "lucide-react";
 ...
 export default function ClassChartsSection({ isStudent, weeklyTrend, benchmark }: ClassChartsSectionProps) {
   ...
   const displayWeekly = weeklyTrend && weeklyTrend.length > 0 ? weeklyTrend : defaultWeeklyData;
   const displayBenchmark = benchmark && benchmark.length > 0 ? benchmark : defaultBenchmarkData;
           ...
           {isStudent ? (
             <div className="h-[300px] w-full">
               <ResponsiveContainer width="100%" height="100%">
                 <RadarChart cx="50%" cy="50%" outerRadius="80%" data={displayBenchmark}>
