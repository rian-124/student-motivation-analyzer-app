...
export function EditLectureModal({ lecture, onEdit, children }: EditLectureModalProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[400px] rounded-2xl border border-slate-100 dark:border-slate-800 shadow-2xl p-0 overflow-hidden bg-white dark:bg-slate-900">
        <DialogHeader className="p-5 pb-2">
          ...
          <DialogTitle className="text-lg font-bold text-slate-800 dark:text-white leading-none">Ubah Data Dosen Wali</DialogTitle>
          <DialogDescription className="text-slate-400 text-[11px] mt-1.5 leading-relaxed">
            Perbarui informasi detail untuk dosen wali pengajar ini.
          </DialogDescription>
        </DialogHeader>
