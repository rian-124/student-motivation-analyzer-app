        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
          ...
          <div className="lg:max-w-md">
            <p className="text-brand-secondary/60 text-lg font-medium leading-relaxed">
              Sistem ini memanfaatkan berbagai teknik pemrosesan data untuk
              mengklasifikasikan dan mengukur metrik keterlibatan mahasiswa
              melalui titik data multimodal.
            </p>
          </div>
        </div>
