          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="space-y-4">
              <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter leading-tight">
                Evaluasi Prototipe
                <br />
                <span className="bg-gradient-to-r from-brand-accent to-yellow-200 bg-clip-text text-transparent">
                  Sistem Analisis.
                </span>
              </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Button
                asChild
                size="lg"
                className="h-14 px-8 rounded-2xl bg-brand hover:bg-brand-hover text-white font-bold text-lg shadow-xl hover:shadow-brand/20 transition-all hover:scale-105 group"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-14 px-8 rounded-2xl border-white/20 bg-white/5 text-white hover:bg-white/10 font-bold text-lg backdrop-blur-sm transition-all hover:scale-105"
              >
                <Link href="#features">Tinjauan Metodologi</Link>
              </Button>
            </div>
