      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <Card className="lg:col-span-4">
          <CardContent className="p-6 text-center space-y-4">
            ...
            {/* NAME */}
            <div>
              <h2 className="font-semibold text-lg text-brand-secondary">
                Admin Sistem
              </h2>
        ...
        <div className="lg:col-span-8 space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm" htmlFor="profile-full-name">
                    Nama Lengkap
                  </label>
                  <Input id="profile-full-name" defaultValue="Admin Sistem" />
                </div>

                <div className="space-y-2">
                  <label className="text-sm" htmlFor="profile-identity-number">
                    NIM / NIP
                  </label>
                  <Input id="profile-identity-number" defaultValue="ADM001" />
                </div>
                ...
                <div className="space-y-2">
                  <label className="text-sm" htmlFor="profile-phone">
                    No. Telepon
                  </label>
                  <Input id="profile-phone" defaultValue="+62 812-3456-7890" />
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm" htmlFor="profile-old-password">
                    Password Lama
                  </label>
                  <Input
                ...
                <div className="space-y-2">
                  <label className="text-sm" htmlFor="profile-new-password">
                    Password Baru
                  </label>
                  <Input
